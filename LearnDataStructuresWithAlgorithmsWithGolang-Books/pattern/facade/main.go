...
//Account class
//method create - creates account given AccountType
...
func main()  {
	...
	customer, account = facade.createCustomerAccount("sam", "savings")
	fmt.Println(customer.name)
	fmt.Println(account.accountType)


	var trasaction = facade.createTransaction("1321","!231", 100)
	fmt.Println(trasaction.amount)
